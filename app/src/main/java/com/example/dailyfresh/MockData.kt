...
import com.example.dailyfresh.MockData.topNewsList
...
// when getNews is called we get newsId which is
// going to return a NewsData object
//since we just want to get the news related to the id by using the id only
// rather than using all the things





// here we make a String from date
    // date is used as an Input here
    fun Date.getTimeAgo() :String {
        val calendar = Calendar.getInstance()
        // getting  the instance of the calendar
        calendar.time = this
        // according to time right now


        //instances of publishing year,month,etc from the calendar
